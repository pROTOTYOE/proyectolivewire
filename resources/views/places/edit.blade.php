<x-app-layout>
    ...
    <div class="text-center py-4">
        <h1 class="font-semibold text-3xl">Editar Lugar</h1>
    </div>
    ...
    <form action="{{route('lugares.update', $lugar)}}" method="post" class="p-4">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label for="departamento" class="block mb-2 text-sm font-medium text-white-900 dark:text-black">Departamento</label>
                <input type="text" id="departamento" name="departamento" value="{{$lugar->departamento}}" class="bg-gray-50 border border-white-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingrese el nombre del departamento">
            </div>
            <div>
                <label for="municipio" class="block mb-2 text-sm font-medium text-white-900 dark:text-black">Municipio</label>
                <input type="text" id="municipio" name="municipio" value="{{$lugar->municipio}}" class="bg-gray-50 border border-white-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingrese el nombre del municipio">
            </div>
            <div>
                <label for="aldea" class="block mb-2 text-sm font-medium text-white-900 dark:text-black">Aldea</label>
                <input type="text" id="aldea" name="aldea" value="{{$lugar->aldea}}" class="bg-gray-50 border border-white-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingrese el nombre de la aldea">
            </div>
            <div>
                <label for="ktm_aprox" class="block mb-2 text-sm font-medium text-white-900 dark:text-black">Kilometro</label>
                <input type="text" id="ktm_aprox" name="ktm_aprox" value="{{$lugar->ktm_aprox}}" class="bg-gray-50 border border-white-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingrese la distancia en kilomentro">
            </div>
        </div>
